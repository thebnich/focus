...
extension BrowserViewController: BrowserDelegate {
    ...
    func browser(_ browser: Browser, scrollViewDidScroll scrollView: UIScrollView) {
        ...
        guard scrollBarState != .animating else { return }
        ...
        guard isDragging, pageExtendsBeyondScrollView, dragDelta < 0 || toolbarsHiddenAtTopOfPage || scrollBarState == .transitioning else { return }
